      ...
      <div class="container-max">
        <div class="text-center mb-12">
          ...
          <div class="mt-6 flex items-center justify-center space-x-2">
            <span class="text-gray-500">Viele Workshops powered by</span>
            <a href="https://workshops.de" 
               target="_blank" 
               rel="noopener noreferrer"
               class="inline-flex items-center space-x-2 group">
              <div class="w-6 h-6 bg-angular-red rounded flex items-center justify-center group-hover:scale-110 transition-transform">
                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
              </div>
              <span class="font-semibold text-angular-red group-hover:underline">Workshops.de</span>
            </a>
          </div>
        </div>
